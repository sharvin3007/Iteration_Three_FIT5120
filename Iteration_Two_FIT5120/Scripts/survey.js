...
var json = {
    "completedHtml": "<h3>Thank you for completing the form.</h3><h5> Based on your answers, it appears that you may be eligible to make an application for an order to stop bullying at work.</h5><h6>We will help us to provide you with a viable solution!</h6>",
    pages: [
        {
            name: "page1",
            elements: [
